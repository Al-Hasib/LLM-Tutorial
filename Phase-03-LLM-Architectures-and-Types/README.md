...
Shrinking a trained model (distillation, pruning, quantization) is a *deployment* concern, not a fourth architecture family, so it's covered later, in **[Phase 09 Lesson 5: Model Distillation and Pruning](../Phase-09-Deployment-and-Inference-Optimization/05-Model-Distillation-and-Pruning/README.md)** — the mechanism behind DistilBERT (mentioned in [Lesson 2](02-Encoder-Only-Models-BERT-Family/README.md#6-roberta-and-todays-encoder-only-landscape)) and DistilGPT2. It applies to every architecture on this page: you can distill a decoder-only, encoder-only, or encoder-decoder teacher into a smaller student of the same family.
