...
- **Interleaved, multi-image, and generation-of-images cases**: this lesson covers understanding images as input; some frontier systems also *generate* images or video as output, which requires a different decoding mechanism (diffusion, or discrete image-token autoregression).

Each of these gaps is taken up properly in **[Phase 11 — Vision-Language Models](../../Phase-11-Vision-Language-Models/README.md)**, which is the eleven-lesson deep dive this lesson previews: vision encoders and the resolution/token trade ([11.01](../../Phase-11-Vision-Language-Models/01-Vision-Encoders-and-Image-Tokenization/README.md)), what contrastive pretraining discards ([11.02](../../Phase-11-Vision-Language-Models/02-Vision-Language-Pretraining-Objectives/README.md)), the three fusion strategies including Flamingo's cross-attention ([11.03](../../Phase-11-Vision-Language-Models/03-VLM-Architectures-and-Fusion-Strategies/README.md)), resamplers and token compression ([11.04](../../Phase-11-Vision-Language-Models/04-Connectors-and-Visual-Token-Compression/README.md)), the staged training pipeline ([11.05](../../Phase-11-Vision-Language-Models/05-Training-a-VLM-Staged-Pipeline/README.md)), instruction data ([11.06](../../Phase-11-Vision-Language-Models/06-Visual-Instruction-Tuning-and-VLM-Data/README.md)), hallucination and alignment ([11.07](../../Phase-11-Vision-Language-Models/07-VLM-Hallucination-and-Alignment/README.md)), grounding/OCR/video/GUI capabilities ([11.08](../../Phase-11-Vision-Language-Models/08-VLM-Capabilities-Grounding-OCR-Video-GUI/README.md)), evaluation ([11.09](../../Phase-11-Vision-Language-Models/09-Evaluating-VLMs/README.md)), serving ([11.10](../../Phase-11-Vision-Language-Models/10-VLM-Inference-and-Deployment/README.md)), and multimodality beyond vision — audio, video, 3D and any-to-any generation ([11.11](../../Phase-11-Vision-Language-Models/11-Beyond-Vision-Full-Multimodality/README.md)).
