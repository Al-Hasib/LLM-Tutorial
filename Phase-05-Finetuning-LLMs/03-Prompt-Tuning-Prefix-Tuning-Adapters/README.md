...
- Core concept: Prompt Tuning, Prefix Tuning and Adapters
- Key ideas: Other parameter-efficient methods: soft prompts, prefix vectors, and bottleneck adapter layers.
