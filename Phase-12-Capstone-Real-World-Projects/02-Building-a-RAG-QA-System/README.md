...
**Phase:** [Capstone: Real-World Projects](../README.md) · **Topic folder:** `02-Building-a-RAG-QA-System`

> Content for this lesson is not yet written — placeholder scaffold.

## What this lesson covers

- Core concept: Building a RAG Q&A System
- Key ideas: A complete retrieval-augmented Q&A app over a real document set.
