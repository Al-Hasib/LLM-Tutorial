...
- [Phase 11 Lesson 7 — VLM Hallucination and Alignment](../../Phase-11-Vision-Language-Models/07-VLM-Hallucination-and-Alignment/README.md), for where the grounding failures this lesson grades actually come from, and [Phase 11 Lesson 9 — Evaluating VLMs](../../Phase-11-Vision-Language-Models/09-Evaluating-VLMs/README.md) for the benchmark-level version of the same problem
